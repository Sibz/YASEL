...
namespace ConnectorManager
{
    ...
    class ConnectorManager
    {
        ...
        public ConnectorManager(MyGridProgram gp, bool ongrid = true)
        {
            Connectors = new List<IMyTerminalBlock>();
            if (ongrid)
                gp.GridTerminalSystem.GetBlocksOfType<IMyBatteryBlock>(Connectors, b => { return b.CubeGrid==gp.Me.CubeGrid; });
            else
                gp.GridTerminalSystem.GetBlocksOfType<IMyBatteryBlock>(Connectors);
        }
